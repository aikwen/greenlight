...
func ValidatePasswordPlaintext(v *validator.Validator, plaintextPassword string) {
	...
	v.Check(len(plaintextPassword) >= 8, "password", "must be at least 8 characters")
...
func (m UserModel) GetForToken(tokenScope, tokenPlaintext string) (*User, error) {
	// Calculate the SHA-256 hash of the plaintext token provided by
	// the client.
	// Remember that this returns a byte *array* length 32, not a slice
